...
//  Copyright (c) 2015 kidsedu. All rights reserved.
//
...
//        
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "com.kidsedu.ss" in the application's documents Application Support directory.
